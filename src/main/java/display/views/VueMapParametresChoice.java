...
public class VueMapParametresChoice extends Pane implements Observateur {
    Slider nombreEquipesSlider;
    Label nombreEquipesValue;

    public VueMapParametresChoice() {
        super();
    }
